...
const Courses = () => {
  ...
  const allCourses = [
    ...
    { id: 3, title: 'Database Management Systems', category: 'cs', difficulty: 'Intermediate', duration: '7 weeks', icon: 'database' },
    { id: 4, title: 'Operating Systems', category: 'cs', difficulty: 'Advanced', duration: '10 weeks', icon: 'monitor' },
    { id: 5, title: 'Computer Networks', category: 'cs', difficulty: 'Intermediate', duration: '8 weeks', icon: 'wifi' },
    { id: 6, title: 'Software Engineering', category: 'cs', difficulty: 'Intermediate', duration: '9 weeks', icon: 'settings' },
    { id: 7, title: 'Cybersecurity Basics', category: 'cs', difficulty: 'Beginner', duration: '5 weeks', icon: 'lock' },
    { id: 8, title: 'Cloud Computing', category: 'cs', difficulty: 'Intermediate', duration: '7 weeks', icon: 'cloud' },
    { id: 9, title: 'Mobile App Development', category: 'cs', difficulty: 'Intermediate', duration: '8 weeks', icon: 'smartphone' },
    { id: 10, title: 'DevOps Essentials', category: 'cs', difficulty: 'Advanced', duration: '6 weeks', icon: 'refresh' },
    { id: 11, title: 'Blockchain Technology', category: 'cs', difficulty: 'Advanced', duration: '8 weeks', icon: 'grid' },
    { id: 12, title: 'Python Programming', category: 'cs', difficulty: 'Beginner', duration: '6 weeks', icon: 'code' },
    { id: 13, title: 'JavaScript Mastery', category: 'cs', difficulty: 'Intermediate', duration: '7 weeks', icon: 'zap' },
    { id: 14, title: 'React & Frontend Development', category: 'cs', difficulty: 'Intermediate', duration: '8 weeks', icon: 'layers' },
    { id: 15, title: 'Git & Version Control', category: 'cs', difficulty: 'Beginner', duration: '4 weeks', icon: 'git-branch' },
    ...
    { id: 19, title: 'Natural Language Processing', category: 'ai', difficulty: 'Advanced', duration: '9 weeks', icon: 'message-square' },
    { id: 20, title: 'Computer Vision', category: 'ai', difficulty: 'Advanced', duration: '10 weeks', icon: 'eye' },
    ...
    { id: 24, title: 'Information Literacy & Research', category: 'digital', difficulty: 'Beginner', duration: '5 weeks', icon: 'search' },
    { id: 25, title: 'Productivity Tools & Software', category: 'digital', difficulty: 'Beginner', duration: '6 weeks', icon: 'bar-chart' },
  ];
    ...
    <div style={{ minHeight: '100vh', background: '#F0EDEE', padding: '40px 20px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.3s',
                boxShadow: selectedCategory === cat.value ? '0 4px 12px rgba(79, 172, 254, 0.3)' : 'none'
              }}
              onMouseEnter={(e) => {
        ...
        {filteredCourses.length > 0 ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px 20px', background: 'white', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.08)' }}>
